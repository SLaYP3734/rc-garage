...
//
// Kartın tamamı tıklanabilir (soru detayına gider), ama kullanıcı adı
// ayrıca kendi profiline gitsin diye <a> içine <a> koyamıyoruz (geçersiz
// HTML) — bu yüzden kart artık bir <Link> değil, tıklamayı kendisi
// yöneten bir <div>.
export default function ProblemCard({ problem }: { problem: Problem }) {
  ...
  return (
    <div
      onClick={() => router.push(`/sorun/${problem.slug}`)}
