...
export const metadata: Metadata = {
  title: { absolute: 'RC Atölyesi — Uzaktan Kumandalı Severlerin Platformu' },
  description:
    'RC araçlarla ilgili bakım rehberleri, teknik yazılar ve haberler — ayrıca arıza/bakım sorularının sorulup cevaplandığı, ikinci el alım satımın yapıldığı Türkçe RC topluluğu.'
};
  ...
  return (
    <div className="px-4 py-6">
      <div className="mb-5 flex items-center justify-between gap-2">
        <div>
          <h1 className="text-xl font-extrabold">📖 RC Atölyesi Blog</h1>
          <p className="mt-1 text-[13px] text-muted">RC araçlarla ilgili bakım rehberleri ve teknik yazılar.</p>
        </div>
        <Link
          href="/sorular"
          className="shrink-0 rounded-xl border border-border bg-cardAlt px-3.5 py-2.5 text-center text-[13px] font-bold leading-tight text-zinc-200"
        >
          🔧 Akışa Geç
        </Link>
      </div>
